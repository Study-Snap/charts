...
{{/*
Create a default fully qualified app name for neptune.
...
Common labels
*/}}
{{- define "neptune.labels" -}}
helm.sh/chart: {{ include "neptune.chart" . }}
{{ include "neptune.selectorLabels" . }}
{{- if .Chart.AppVersion }}
